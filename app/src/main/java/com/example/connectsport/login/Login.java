...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.connectsport.R.layout.activity_login);

        Toolbar toolbar = findViewById(com.example.connectsport.R.id.toolbar);
        setSupportActionBar(toolbar);
        forgottenPassword_btn = findViewById(com.example.connectsport.R.id.forgottenPassword);
        mailPassworAccess_btn = findViewById(com.example.connectsport.R.id.mailPasswordAccess_button);
        lMail = findViewById(R.id.til_login_mail);
        lPasswd = findViewById(R.id.til_login_password);
        editmail = findViewById(com.example.connectsport.R.id.editmail);
        editpass = findViewById(com.example.connectsport.R.id.editpass);
